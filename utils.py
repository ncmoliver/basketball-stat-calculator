...
# Step 6: Calculate Production, Efficiency, and Effectiveness for Player and Team
def production(made, attempted):
    missed = attempted - made
    production = made - missed
    return production

def efficiency(made, attempted):
        efficiency = round((made / attempted)*100, 2)
        return efficiency

def effective(pProduction, tProduction):
        effective = round((pProduction / tProduction)*100, 2)
        return effective
